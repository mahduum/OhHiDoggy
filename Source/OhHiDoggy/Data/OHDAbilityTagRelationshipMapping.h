...
#include "OHDAbilityTagRelationshipMapping.generated.h"

USTRUCT()
struct FOHDAbilityTagRelationship
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class OHHIDOGGY_API UOHDAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
