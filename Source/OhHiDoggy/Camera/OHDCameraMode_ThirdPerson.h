...
#include "OHDPenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "OHDCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UOHDCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class OHHIDOGGY_API UOHDCameraMode_ThirdPerson : public UOHDCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FOHDPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
